<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">很抱歉~，您访问的页面不存在</div>
        <div class="bullshit__info">请检查访问的链接是否正确，或者点击下方按钮回到首页</div>
...
import four from "@/assets/404_images/404.png";
import four_cloud from "@/assets/404_images/404_cloud.png";
